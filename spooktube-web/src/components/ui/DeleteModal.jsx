            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer d-flex justify-content-evenly">
                        <button id={`delete-modal-${id}-cancel`} type="button" className="btn btn-secondary w-25" onClick={cancelDelete}>Cancel</button>
                        <button id={`delete-modal-${id}-confirm`} type="button" className="btn btn-danger w-25" onClick={confirmDelete}>Delete</button>
                    </div>
                </div>
            </div>
        </div>
