    ...
    return (
        <div role="comment" className={`row bg-secondary-subtle mt-2 me-2 ms-1 p-2 ${display} position-relative`}>
            <div className="col-3 text-center py-0 ps-4 text-break">
                <p className="user-icon border border-4 border-dark rounded-circle mb-0 mx-auto py-2 text-black text-center user-select-none overflow-hidden" style={{ backgroundColor: comment.userId.iconColour }}>
                    {comment.userId.iconText}
                </p>
                <p className="fw-bold">{comment.userId.username}</p>
            </div>
